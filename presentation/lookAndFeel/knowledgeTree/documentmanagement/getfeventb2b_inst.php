...
$comm0="SELECT value,document_id FROM `document_fields_link` WHERE document_field_id = 12 AND `document_id` =".$row0[0];
...
echo "<td ><font size=2 face='Arial'>". $comm2[0]."</font></td>";
