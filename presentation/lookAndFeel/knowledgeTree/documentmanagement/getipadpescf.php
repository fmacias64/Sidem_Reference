...
if($region=="GLOBAL")
{
$where1.="AND ( fregion.document_field_id=110 AND ( fregion.value = 'Global' OR fregion.value = 'GLOBAL') AND b.`id` = fregion.`document_id` )";
}
else
if($region=="NOTG")
{
$where1.="AND ( fregion.document_field_id=110 AND ( fregion.value != 'Global' AND fregion.value != 'GLOBAL') AND b.`id` = fregion.`document_id` )";
}
else
...
function listanotas2($letra,$nota,$region,$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,$industria,$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,$cuantos,$titulo,$elque) 
{ 
$cuenta =0;
$storend="";
$imphtml2.="";
...
$indv_rel= "SELECT * FROM `document_fields_link` WHERE `document_field_id`<> 1  AND (document_field_id=161 or document_field_id=109 or document_field_id=142 or document_field_id=164  or document_field_id=113 or document_field_id=82  or document_field_id=114 or document_field_id=273 or document_field_id=274 or document_field_id=276 or document_field_id=275) AND `document_id`=".$busq_links2[0];
$indv_rel1 = mysql_query($indv_rel);
...
function imprime_web3($mistring,$mistring2)
{
 ...
 $imphtml.= "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" />";
	//$sToRender .= 	"<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\n"; 
$imphtml.= "<title>Impeccable    by Free CSS Templates</title>";
 $imphtml.= "<link href=\"styleipadpesc2.css\" rel=\"stylesheet\" type=\"text/css\" media=\"screen\" />";
 $imphtml.= "</head>";
 $imphtml.= "<body>";
 $imphtml.= "<div id=\"wrapper\">";
 $imphtml.= "<div id=\"page\">";
