    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// English
             ...
             scwInvalidDateMsg      = 'La fecha es invalida O.o!!.\n';
             scwOutOfRangeMsg       = 'La fecha esta fuera del rango! -.-.';
             scwDoesNotExistMsg     = 'Esa fecha no existe hahahah!.';
...
// ***************************
    ...
    document.write(
     "<iframe class='scw' " + (scwID('scwIElt7')?"src='/scwblank.html '":'') +
             "id='scwIframe' name='scwIframe' frameborder='1'>" +
     "</iframe>" +
