...
$storend.="<tr><td><font face='Arial' size='5'><a href=\"http://proveedores.intelect.com.mx/FichasBD/branches/SY/control.php?action=getsium2&amp;letra=".$busq_links2[0]."\">";
$sumsql=str_replace('"',"'",$summarysql);
...
//echo $compnotesql."<br>";
$storend.= "<font face='Arial' size='5'>".substr($comphtml,0,200);
$storend.="...<a href=\"http://proveedores.intelect.com.mx/FichasBD/branches/SY/control.php?action=getsium2&amp;letra=".$busq_links2[0]."\">Ver m&aacute;s</a>";
