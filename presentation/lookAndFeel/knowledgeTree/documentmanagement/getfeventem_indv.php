...
echo "<link rel=\"stylesheet\" href=\"$default->uiUrl/stylesheet.php\">\n";
 echo "<table style='text-align: left; width:40% ; ' border='0'  cellpadding='2' cellspacing='2'><tbody>
...
$oDocument = & Document::get($iddoc);
  ...
  echo "<tr><TH colspan='3'align='center' bgcolor='orange' ><font size=1 face='Arial' color='white'>Datos Evento Empresarial</font></tr> <tr><td valign='top' height=40% align='left'>";
...
echo "<font size=1 face='Arial' color='blue'>Nombre</font></td>
<td><font size=1 face='Arial'>".$nom."</font></td>";
...
<tr>
<td><font size=1 face='Arial' color='blue'>Comentario</font></td>
<td ><font size=1 face='Arial'>".$coment ."</font></td>
...
echo "<tr><td>";
echo "<table width=100% height=50%  align='left' style='text-align: left' ; ' border='0'  cellpadding='2' cellspacing='2'><th bgcolor='orange'><font size=1 face='Arial'  color='blue'><center>Relaci&oacute;n</center></font></th><tbody>";
echo "<tr>";


echo "<tr>";
echo "<th><font size=1 face='Arial' color='blue'>Nombre</font></td>";
echo "<td ><font size=1 face='Arial'><a href='/FichasBD/branches/SY/control.php?action=getficha&letra=".$row32[2] ."' target='fichas2' >".$r32[1]." ".$r32[2]." ".$r32[3]." ".$r32[4]." ".$r32[5]." ".$r32[6]."</a></font></td>";
echo "</tr>";
echo "<tr>";
echo "<th><font size=1 face='Arial' color='blue'>Nombre</font></td>";
echo "<td ><font size=1 face='Arial'><a href='/FichasBD/branches/SY/control.php?action=getfeventb2b&letra=".$row33[2] ."' target='fichas2' > ".$r33[1]." ".$r33[2]." ".$r33[3]." ".$r33[4]." ".$r33[5]." ".$r33[6]."</a></font></td>";
echo "</tr>";
...
echo "<tr><td>";
echo "<table width=100% height=50%  align='left' style='text-align: left' ; ' border='0'  cellpadding='2' cellspacing='2'><th colspan='3' bgcolor='orange'><font size=1 face='Arial'  color='blue'><center>Relaci&oacute;n</center></font></th><tbody>";
echo "<tr>";


echo "<tr>";
echo "<th><font size=1 face='Arial' color='blue'>Nombre</font></td>";
echo "<td ><font size=1 face='Arial'><a href='/FichasBD/branches/SY/control.php?action=getficha&letra=".$row33[2] ."' target='fichas2' > ".$r33[1]." ".$r33[2]." ".$r33[3]." ".$r33[4]." ".$r33[5]." ".$r33[6]."</a></font></td>";
echo "</tr>";

echo "<tr>";
echo "<th><font size=1 face='Arial' color='blue'>Nombre</font></td>";
echo "<td ><font size=1 face='Arial'><a href='/FichasBD/branches/SY/control.php?action=getfeventb2b&letra=".$row32[2] ."' target='fichas2' >".$r32[1]." ".$r32[2]." ".$r32[3]." ".$r32[4]." ".$r32[5]." ".$r32[6]."</a></font></td>";
echo "</tr>";
}
