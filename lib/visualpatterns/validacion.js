...
//dropCondicional
function Display() {
	var newLoc = document.getElementById("dropCondicional");
	var newPage = newLoc.options[newLoc.selectedIndex].value;

	if (newPage != "") {
		document.getElementById("displayDiv").innerHTML = newPage;
	}
			else { 
...
formValidationMasks['numerico'] = /^[0-9]+$/gi;	
...
{
	//dropCondicional---------------------------------------->
	document.getElementById("dropCondicional").selectedIndex = 0;
	document.getElementById("dropCondicional").onchange = Display;
	//dropCondicional<--------------------------------------
