...
echo imprime_web2(listanotas($letra,$nota,$region,$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,$industria,$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,15,$region), "" );
/****
echo "<table><tr><td>";
