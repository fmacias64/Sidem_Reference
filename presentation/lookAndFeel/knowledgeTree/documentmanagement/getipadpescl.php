...
if (($titulo == "Politics") or ($titulo=="Economics") or ($titulo=="Social") or ($titulo=="Contingencies")) {
echo imprime_web3(listanotas2($letra,$nota,$region,$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,$industria,$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,15,$titulo,$elque), "" );

}

else  {

echo imprime_web3(listanotas($letra,$nota,$region,$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,$industria,$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,15,$titulo,$elque), "" );
}
...
function imprime_web411($mistring,$mistring2)
{
