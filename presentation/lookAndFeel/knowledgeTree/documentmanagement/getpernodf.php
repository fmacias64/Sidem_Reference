...
function listanotas($letra,$nota,$region,$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,$industria,$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,$cuantos,$titulo) 
{ 
$cuenta =0;
$storend="";
$imphtml2.="";
...
{
$where1.="AND ( ffechaa.document_field_id=109 AND ffechaa.value > (CURDATE()-INTERVAL 2 MONTH)  AND b.`id` = ffechaa.`document_id` )";
}
else
{
...
$preliga.= "<a href='http://proveedores.intelect.com.mx/FichasBD/branches/SY/control.php?action=getpernodl";
...
$indv_rel= "SELECT * FROM `document_fields_link` WHERE `document_field_id`<> 1  AND (document_field_id=161 or document_field_id=109 or document_field_id=142 or document_field_id=164  or document_field_id=113 or document_field_id=115 or document_field_id=114 ) AND `document_id`=".$busq_links2[0];
...
$imphtml2.="	<div class=\"post\">";
 $imphtml2.= "					<h2 class=\"title\">".$fech."&nbsp;&nbsp;<a href=\"http://proveedores.intelect.com.mx/FichasBD/branches/SY/control.php?action=getpernod2&amp;letra=".$busq_links2[0]."
\">".$sumsql2." </a></h2>";

 $imphtml2.= "					<div class=\"entry\">";
 $imphtml2.= "					<span class=\"posted\"><a href=\"http://proveedores.intelect.com.mx/FichasBD/branches/SY/control.php?action=getpernod2&amp;letra=".$busq_links2[0]."\">Read More</a>    </span>";
