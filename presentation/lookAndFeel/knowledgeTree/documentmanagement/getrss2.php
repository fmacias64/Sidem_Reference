...
if ($fechaA=="") {$fechaA="(CURDATE()-INTERVAL 2 WEEK)";}
if($parampais=="")
{
}else
{
...
echo "<channel rdf:about=\"http://proveedores.intelect.com.mx/FichasBD/branches/SY/presentation/lookAndFeel/knowledgeTree/documentmanagement/getrss2.php\">"; //cambiar aqui
echo "\r\n";
echo "    <title>Eventos Empresariales</title>";
echo "\r\n";
echo "    <description>RSS 1.0 export from the B2B Events Records.</description>";
echo "\r\n";
echo "    <link>http://proveedores.intelect.com.mx/FichasBD/branches/SY/presentation/lookAndFeel/knowledgeTree/documentmanagement/getrss2.php</link>"; //cambiar aqui
echo "\r\n";
...
echo "\r\n";
//$tiempo=explode("-",$fech);
//echo "f ".date("D, j M Y G:i:s T",mktime(0,0,0,$tiempo[1],$tiempo[2],$tiempo[0]))." f2 ".date("j-m-Y\TG:i:s\Z",$fech)." f ".$fech." f5 ";
/***
echo "\"".$regsql."\","; //**
echo "\r\n";
 echo "\"".$partnom."\",";
...
$txt = str_replace("\x97","\"",$txt);
 ...
 // $txt = stri_replace("<a href=http://","&lt;a target=\"_blank\" href=http://",$txt);
  ...
  //Basic formatting
  $eol = ( strpos($txt,"\r") === FALSE ) ? "\n" : "\r\n";
  //$html = str_replace("$eol$eol","&lt;/p&gt;&lt;p&gt;",$txt);
  $html=$txt;
  //$html = str_replace("$eol","&lt;br /&gt;\n",$html);
  //$html = str_replace("&lt;/p&gt;","&lt;/p&gt;\n\n",$html);
  //$html = str_replace("&lt;p&gt;&lt;/p&gt;","&lt;p&gt;&nbsp;&lt;/p&gt;",$html);
 ...
 //$html = str_replace(">","&gt;",$html);
  //Wipes <br> after block tags (for when the user includes some html in the text).
 //$html = str_replace("&amp;ntilde;","n",$html);
//$html = str_replace("&amp;Ntilde;","N",$html);
  /**** $wipebr = Array("table","tr","td","blockquote","ul","ol","li");
