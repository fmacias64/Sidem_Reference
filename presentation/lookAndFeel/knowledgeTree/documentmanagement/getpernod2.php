...
//=======================>>>>> INICIA ==============>>>>>
 ...
 $storend.= "<table  align='center' style='text-align: left; width:700px ;height:80%; ' border='0'  cellpadding='2' cellspacing='2' >
<tr>
...
$oDocument = & Document::get($iddoc);
  ...
  $storend.="<tr>
<th rowspan='1' align='center'><a href='http://proveedores.intelect.com.mx/FichasBD/branches/SY/presentation/lookAndFeel/knowledgeTree/documentmanagement/getpernod.php' title='Inicio' ><font color='darkblue'><img src='images/PRsm.jpeg' width='40' height='40' alt='pagina de inicio'></a></th>
...
<!--- <td>Date</td> -->
<td></td>
<td><font face='Times' size='4'>".$date."</td></tr>";
}
...
<!--- <td>Region</td> -->
<td></td>
<td><font face='Times' size='4'>".$reg."</td>
</tr>";
}
...
<!--- <td>Country</td> -->
<td></td>
<td><font face='Times' size='4'>".$country ."</td>
</tr>";
}
...
<!--- <td>City</td> -->
<td></td>
<td colspan='1'><font face='Times' size='4'>".$partnom."</td>
</tr>";
}
...
<!--- <td>Plant</td> -->
<td></td>
<td colspan='1'><font face='Times' size='4'>".$plant."</td>
</tr>";
}
...
<!--- <td>Competitor</td> -->
<td></td>
<td colspan='1'><font face='Times' color='red' size='4'>".$partnomcomp."</font></a></td>
</tr>";
}
/**
if(empty($sour)){
...
<!--- <td>Source</td> -->
<td></td>
<td><font face='Times' size='4'>".$sour."</td>
</tr>";
}
*/
if(empty($compd)){
...
<td></td>
<td><font face='Times' size='4'>".$compd."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$act."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$compds."</td>
</tr>";
}
...
<!--- <td>Amount</td> -->
<td></td>
<td><font face='Times' size='5'>".$amount."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$add."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$compsp."</td>
</tr>";
}
...
<!--- <td>Is Technology?</td> -->
<td></td>
<td><font face='Times' size='4'>".$istec."</td>
</tr>";
}
...
<td></td>
<td colspan='1'><font face='Times' size='4'>".$tecte."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$techs."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$techd."</td>
</tr>";
}
...
<td></td>
<td ><font face='Times' size='4'>".$issusta."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$suste."</td>
</tr>";
}
...
<td></td>
<td colspan='1'><font face='Times' size='4'>".$sustp."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$sustt."</td>
</tr>";
}
...
<!--- <td>Is Corporate?</td> -->
<td></td>
<td ><font face='Times' size='4'>".$iscorp."</td>
</tr>";
}
...
<!--- <td>Total Income</td> -->
<td></td>
<td><font face='Times' size='4'>".$total."</td>
</tr>";
}
...
<!--- <td>Gross Profits</td> -->
<td></td>
<td><font face='Times' size='4'>".$rect."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$operI."</td>
</tr>";
}
...
<!--- <td>Net Revenue</td> -->
<td></td>
<td><font face='Times' size='4'>".$netr."</td>
</tr>";
}
...
<!--- <td>EBITDA</td> -->
<td></td>
<td><font face='Times' size='4'>".$ebitda."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$top."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$consq."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$react."</td>
</tr>";
}
...
<td></td>
<td colspan='1'><font face='Times' size='4'>".$relindv."</td>
</tr>";
}
...
<!--- <td>Summary</td> -->
<td></td>
<td colspan='2'><font face='Times' size='4'>".$summ."</td>
</tr>";
}
...
<!--- <td>Complete Note</td> -->
<td></td>
<td colspan='3'><font face='Times' size='4' color='white'>".$notehtml."</td>
</tr>";
}
...
<td></td>
<td><font face='Times' size='4'>".$typeso."</td>
</tr>";
}
