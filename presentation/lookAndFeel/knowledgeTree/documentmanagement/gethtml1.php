...
if ($fechaA=="") {$fechaA="(CURDATE()-INTERVAL 1 DAY)";}
if($nota=="")
{
}else
{
...
if ($region=="" && $event =="" && $reactiontopic != "Competitiveness" && $reactiontopic!="Enviroment/Health" ) {echo "Eventos Empresariales";}
echo "</title>";
...
echo "<title><![CDATA[".$sumsql2."]]></title>";
echo "\r\n";
echo "<description>";
echo "\r\n";
echo "Fecha ".$fech."\n";
...
**/
$storend.="<table border='1' width=511 height=60%  align='center' cellspacing='2' cellpadding='2'>";
$storend.="<tr><td><a href=\"http://proveedores.intelect.com.mx/FichasBD/branches/SY/control.php?action=gethtml2&amp;letra=".$busq_links2[0]."\">";
$sumsql=str_replace('"',"'",$summarysql);
...
//echo $compnotesql."<br>";
$storend.= "<font face='Arial' size='2'>".substr($comphtml,0,200);
$storend.="...<a href=\"http://proveedores.intelect.com.mx/FichasBD/branches/SY/control.php?action=gethtml2&amp;letra=".$busq_links2[0]."\">Ver m&aacute;s</a>";
...
$storend.= "<link>http://proveedores.intelect.com.mx/FichasBD/branches/SY/control.php?action=getfeventb2b&amp;letra=".$busq_links2[0]."</link>";
$storend.= "\r\n";

**/
// "<pubDate>Wed, 29 Jul 2009 16:07:26 GMT</pubDate>";
//date_default_timezone_set('GMT');
/***
$tiempo=explode("-",$fech);
$fechh=date("D, j M Y G:i:s T",$fech);
$storend.= "\r\n";
$storend.= "<pubDate>".date("D, j M Y G:i:s T",mktime(0,0,0,$tiempo[1],$tiempo[2],$tiempo[0]))."</pubDate>";
$storend.= "\r\n";
// "<dc:date>2009-07-29T16:07:26Z</dc:date>";
$storend.= "<dc:date>".date("Y-m-d\TG:i:s\Z",mktime(10,0,0,$tiempo[1],$tiempo[2],$tiempo[0]))."</dc:date>";
$storend.= "\r\n";
$storend.= "<dc:creator>SY</dc:creator>";
$storend.= "\r\n";
$storend.= "<dc:contributor>SY</dc:contributor>";
$storend.= "\r\n";

$storend.= "<dc:language>es</dc:language>";
$storend.= "\r\n";
$storend.= "<dc:subject>Opportunities</dc:subject>";
$storend.= "\r\n";
$storend.= "</item>\n";
$storend.= "\r\n";
...
/***
$storend.= "<xhtml:script id=\"js\" type=\"text/javascript\" src=\"http://www.intelect.com.mx/legislativo/rss.js\" />";
$storend.= "\r\n";
$storend.= "</rdf:RDF>";
$storend.= "\r\n";
**/
