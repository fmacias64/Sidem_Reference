...
$oneeva='(SELECT * FROM `empresa_empresa` where child_id = '. $pfName  .' and (matriz = \'FIRST\'  or matriz = \'Yes\'  or matriz = \'YES\' ) '.$extension.' )'
       .'Union'
       .'(SELECT * FROM `empresa_empresa` where parent_id = '. $pfName  .' and ( matriz = \'SECOND\' or matriz = \'No\'  or matriz = \'NO\') '.$extension.' )'
...
if ($threeva[6]=='FIRST' || $threeva[6]=='YES'){
             $i=0;
            ...
            {
               if ($fecha_primer_jv==$jointventure[7]  && ( $jointventure[6]=='FIRST' ||  $jointventure[6]=='YES' ) ){
...
//solo 1 matriz
 else if ($threeva[6]=='SECOND' || $threeva[6]=='No' || $threeva[6]= '' || $threeva[6] == NULL  ){
...
$oneeva='(SELECT * FROM `empresa_empresa` where child_id = '. $pfName  .' and (matriz = \'SECOND\' or matriz = \'No\' or matriz = \'NO\') '.$extension.' )'
       .'Union'
       .'(SELECT * FROM `empresa_empresa` where parent_id = '. $pfName  .' and (matriz = \'FIRST\' or matriz = \'Yes\' or matriz = \'YES\' )  '.$extension.' )'
       .'order by fecha desc, jv desc';
$twoeva=mysql_query($oneeva);
