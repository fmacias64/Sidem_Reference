...
<td ><font size=1 face='Arial'>".$gen."</font></td>

</tr>
<tr>
<td bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Resumen Ejecutivo</font></td>
<td colspan='2' align='justify'><font size=1 face='Arial'>".$resum."</font></td>
...
echo "<table width=100% height=60%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><th bgcolor='orange' colspan=6><font size=1 face='Arial'  color='white'><center>Trayectoria tipo: $row3[5]</center></font></thead><tbody>";
echo "<tr><td>";
...
echo "</tbody></table></td></tr><tr><td>";
echo "<table width=100% height=60%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><th bgcolor='orange' colspan=6><center><font size=1 face='Arial' color='white'>Trayectoria  tipo: $row3[5]</font></center></thead><tbody>";
echo "<tr><td>";
...
echo "<td ><font size=1 face='Arial'><a href='/FichasBD/branches/SY/control.php?action=getftray_indv&letra=".$row3[0] ."' target='fichas2'>".$row3[5] ."</font></td>";
...
echo "</tbody></table></td></tr><tr><td>";
echo "<table width=100% height=60%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><th bgcolor='orange' colspan=5><center><font size=1 face='Arial' color='white'>Relaci&oacute;n  tipo: $row3[4]</font></center></thead><tbody>";
echo "<tr>";
...
if ($cuentaindiv==0) {
$cuentaindiv++ ;
echo "<table width=100% height=60%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><th bgcolor='orange' colspan=5><center><font size=1 face='Arial' color='white'>Relaci&oacute;n  tipo: $row3[6] 1</font></center></thead><tbody>";
echo "<tr>";
echo "<th bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Nombre</font></th>";
echo "<th bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Direcci&oacute;n</font></th>";
echo "<th bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Fecha de <br> Registro</font></th>";
...
{
echo "<tr><td>";
echo "<table width=100% height=60%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><th bgcolor='orange' colspan=5><font size=1 face='Arial'  color='white'><center>Domicilios</center></font></thead><tbody>";
echo "<tr>";
echo "<th bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Fecha <br>de Registro</font></th>";
...
{
echo "<tr><td>";
echo "<table width=100% height=60%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><th bgcolor='orange' colspan=6><font size=1 face='Arial'  color='White'><center>Eventos</center></font></thead><tbody>";
echo "<tr>";
...
{
echo "<tr><td>";
echo "<table width=100% height=60%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><th bgcolor='orange' colspan=7><font size=1 face='Arial'  color='White'><center>Eventos Empresariales</center></font></thead><tbody>";
echo "<tr>";
echo "<th bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Multimedia</font></th>";
...
{
echo "<tr><td>";
echo "<table width=100% height=70%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><th  colspan=4 bgcolor='orange'><center><font size=1 face='Arial' color='white' >Preferencias</font></center></th></tr><tbody>";
echo "<tr>";
echo "<th bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Fecha <br>de Registro</font></th>";
