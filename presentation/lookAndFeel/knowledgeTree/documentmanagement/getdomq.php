...
if ($region=="" && $event =="" && $reactiontopic != "Competitiveness" && $reactiontopic!="Enviroment/Health" ) {echo "Beverages, Food and Tobacco";}
echo "</title>";
...
$storend.="<tr><td><font face='Arial' size='5'><a href=\"http://proveedores.intelect.com.mx/FichasBD/branches/SY/control.php?action=getdomq2&amp;letra=".$busq_links2[0]."\">";
$sumsql=str_replace('"',"'",$summarysql);
...
$storend.="...<a href=\"http://proveedores.intelect.com.mx/FichasBD/branches/SY/control.php?action=getdomq2&amp;letra=".$busq_links2[0]."\">Ver m&aacute;s</a>";
