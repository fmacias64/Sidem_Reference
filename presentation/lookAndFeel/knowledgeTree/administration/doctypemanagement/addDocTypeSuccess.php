<?php
/**
 * $Id: addDocTypeSuccess.php,v 1.8 2004/11/26 21:10:43 nbm Exp $
 *
...
if(checkSession()) {
    ...
    $Center .= "<tr></tr>\n";
    $Center .= "<tr>\n";
    $Center .= "<td align = right><a href=\"$default->rootUrl/control.php?action=addDocType\"><img src =\"" . KTHtml::getBackButton() . "\" border = \"0\" /></a></td>\n";
    $Center .= "</tr>\n";
    $Center .= "</table>\n";
