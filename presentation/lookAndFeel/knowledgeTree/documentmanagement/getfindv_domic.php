...
echo "<font size=2 face='Times' color='blue'>Fecha de Registro</font></td>
...
echo "
<tr><td><font size=2 face='Times' color='blue'>Fecha de Inicio</font></td>
<td ><font size=2 face='Times' >".$fechini ."</font></td>


</tr>
<tr><td><font size=2 face='Times' color='blue'>Fecha Final</font></td>
<td ><font size=2 face='Times'>".$fechfin ."</font></td>
</tr>

<tr>
<td><font size=2 face='Times' color='blue'>Comentario</font></td>
<td ><font size=2 face='Times'>".$coment ."</font></td>
...
echo "<tr><td>";
echo "<table width=100% height=50%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><thead><font size=2 face='Times'  color='blue'><center>Relaci&oacute;n</center></font></thead><tbody>";
echo "<tr>";
...
echo "<tr>";
echo "<th><font size=2 face='Times' color='blue'>Nombre</font></td>";
echo "<td ><font size=2 face='Times'><a href='/FichasBD/branches/SY/control.php?action=getfDomic&letra=".$row33[2] ."' target='fichas2' > ".$r33[1]." ".$r33[2]." ".$r33[3]." ".$r33[4]." ".$r33[5]." ".$r33[6]."</a></font></td>";
echo "</tr>";
...
echo "<tr>";
echo "<th><font size=2 face='Times' color='blue'>Nombre</font></td>";
echo "<td ><font size=2 face='Times'><a href='/FichasBD/branches/SY/control.php?action=getfDomic&letra=".$row32[2] ."' target='fichas2' >".$r32[1]." ".$r32[2]." ".$r32[3]." ".$r32[4]." ".$r32[5]." ".$r32[6]."</a></font></td>";
echo "</tr>";
}
