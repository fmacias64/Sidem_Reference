...
$busq_links="SELECT `id`, `filename` FROM `documents` WHERE `status_id`<=2 AND `document_type_id`= 33 AND `name` LIKE '%".$letrasar[$i]."%'";
...
if ($indv_rel2[2]==65 ){
 ...
 echo "<a href='/FichasBD/branches/SY/control.php?action=getfmult&letra=".$busq_links2[0]."' target='fichas2' ><font size=2 face='Times'> ".$busq_links2[1]."<br>  ".$com."</font></a>
