<?php
/**
 * $Id: editRoleSuccess.php,v 1.12 2004/11/03 08:12:31 nbm Exp $
 *
 * Edit a role success page.
 *
...
if(checkSession()) {
    ...
    $Center .= "<tr></tr>\n";
    $Center .= "<tr>\n";
    $Center .= "<td align=\"right\"><a href=\"$default->rootUrl/control.php?action=listRoles\"><img src =\"" . KTHtml::getBackButton() . "\" border = \"0\" /></a></td>\n";
    $Center .= "</tr>\n";
    $Center .= "</table>\n";
