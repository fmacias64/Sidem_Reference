...
echo "<font size=2 face='Times' color='blue'>Comentario</font></td>
...
echo "<tr>";
echo "<th><font size=2 face='Times' color='blue'>Nombre</font></td>";
echo "<td ><font size=2 face='Times'><a href='/FichasBD/branches/SY/control.php?action=getfevento&letra=".$row32[2] ."' target='fichas2' >".$r32[1]." ".$r32[2]." ".$r32[3]." ".$r32[4]." ".$r32[5]." ".$r32[6]."</a></font></td>";
echo "</tr>";
...
echo "<tr>";
echo "<th><font size=2 face='Times' color='blue'>Nombre</font></td>";
echo "<td ><font size=2 face='Times'><a href='/FichasBD/branches/SY/control.php?action=getfevento&letra=".$row33[2] ."' target='fichas2' > ".$r33[1]." ".$r33[2]." ".$r33[3]." ".$r33[4]." ".$r33[5]." ".$r33[6]."</a></font></td>";
echo "</tr>";
