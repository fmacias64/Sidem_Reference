...
$param1=listanotas2($letra,$nota,$region,$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,$industria,$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,3,"Politics",1);
$param1.=listanotas2($letra,$nota,$region,$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,$industria,$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,3,"Economics",3);


$param1.=listanotas2($letra,$nota,$region,$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,$industria,$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,2,"Social",2);
$param1.=listanotas2($letra,$nota,$region,$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,$industria,$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,2,"Contingencies",4);


//abajo iran los globales
$param2=listanotas($letra,$nota,"GLOBAL",$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,"BUILDING MATERIALS",$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,4,"Tier 1",6);

//abajo los no globales
$param2.=listanotas($letra,$nota,"NOTG",$event,$action,$type,$competitive,$sustainability,$reactiontype,$reactiontopic,$consequence,$actor,$competidor,"BUILDING MATERIALS",$subindustria,$parampais,$ano,$notime,$fecha1,$fecha2,$apartir,4,"General",7);
