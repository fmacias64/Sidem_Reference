...
$r2 = mysql_query($dbg);
 ...
 echo "<table style='text-align: left; width:100% ; background-color: rgb(220, 220,220);' border='1'  cellpadding='2' cellspacing='2'><tbody>

<tr>
    <td><table width=30% height=40%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><font size=1 face='Times'><tbody>";

   for($i=0; $i<count($letrasar);$i++){
...
$oDocument = & Document::get($busq_links2[0]);
  ...
  echo "<tr><TH rowspan='1'><TH colspan='2'align='center' style='background-color: rgb(120,120,120);'><font size=1 face='Times'>Datos Personales</font></tr> <tr><td valign='top' height=40% align='center'>";

  //======= se integra la imagen del individuo a los resultados de la busqueda ======
 

 echo  "<a href='http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps/control.php?action=viewDocument&fDocumentID=".$busq_links2[0]."' target='fichas2' ><img style=".'"'." width: 70px; height: 70px;".'"'." alt= ".'"'.$oDocument->getName().'"'." src= ".'"'."http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps/Documents". $oDocument->generateFullFolderPath($oDocument->getFolderID())."/".$oDocument->getFileName().'"'." > </a></td>

<td style='background-color: rgb(190, 190,190);'>";
...
$event=displayBotonEventos($oDocument, $bEdit);

 echo "<a href='http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps/control.php?action=viewDocument&fDocumentID=".$busq_links2[0]."' target='fichas2' ><font size=2 face='Times'>".$appat." ".$apmat." ".$nam  ."</font></a>

<td><input type=button  value='agregar evento' onclick=".$event."></td>
<tr><td>Fecha de Nacimiento</td>
<td style='background-color: rgb(190, 190,190);'><a href='http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps/control.php?action=viewDocument&fDocumentID=".$busq_links2[0]."' target='fichas2' ><font size=2 face='Times'>".$fech ."</font></a></td>
</tr>
<tr><td>Nacionalidad</td>
<td style='background-color: rgb(190, 190,190);'><a href='http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps/control.php?action=viewDocument&fDocumentID=".$busq_links2[0]."' target='fichas2' ><font size=2 face='Times'>".$nac ."</font></a></td>
</tr>

<tr><td>Institucion/Cargo</td>
<td style='background-color: rgb(190, 190,190);'><a href='http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps/control.php?action=viewDocument&fDocumentID=".$busq_links2[0]."' target='fichas2' ><font size=2 face='Times'>".$inst." / ".$carg ."</font></a></td>
</tr>
<tr>
<td>Telefono</td>
<td style='background-color: rgb(190, 190,190);'><a href='http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps/control.php?action=viewDocument&fDocumentID=".$busq_links2[0]."' target='fichas2' ><font size=2 face='Times'>".$tel ."</font></a></td>

</tr>

<tr>
<td>E-mail</td>
<td style='background-color: rgb(190, 190,190);'><a href='http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps/control.php?action=viewDocument&fDocumentID=".$busq_links2[0]."' target='fichas2' ><font size=2 face='Times'>".$mail ."</font></a></td>

</tr>

<tr>
<td>Direcci&oacute;n</td>
<td style='background-color: rgb(190, 190,190);' ><a href='http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps/control.php?action=viewDocument&fDocumentID=".$busq_links2[0]."' target='fichas2' ><font size=2 face='Times'>".$dir." ".$dir1." ".$cpos ."</font></a></td>

</tr>

<tr>
<td>Due&ntilde;o de la Relaci&oacute;n</td>
<td style='background-color: rgb(190, 190,190);'><a href='http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps/control.php?action=viewDocument&fDocumentID=".$busq_links2[0]."' target='fichas2' ><font size=2 face='Times'>".$rel." ".$rel1." ".$rel2." ".$rel3 ."</font></a></td>
...
<tr><td><iframe src='http://www.intelect.com.mx:82/~FichasBD/branches/fichas_cps' name='fichas2' width='500' height='500' scrolling='auto' frameborder='1' transparency></iframe></td></tr></tbody></tbody></table>
