...
$busq_links="SELECT a.`document_id` FROM `document_fields_link`as a,`documents`as b  WHERE a.`document_field_id`=78 AND b.`id`= a.`document_id`AND b.`status_id`<=2 AND b.`document_type_id`= 14 AND a.`value` LIKE '".$valor."%'";
...
<tr><td valign='top' height=40% align='left'>";
...
if ($indv_rel2[2]==65 ){
 ...
 echo "<a href='/FichasBD/branches/SY/control.php?action=getfinanzas&letra=".$busq_links2[0]."' target='fichas2' ><font size=2 face='Times'>".$fech." ".$tipo."</font></a>
