...
$oDocument = & Document::get($iddoc);
  ...
  echo "<tr><TH rowspan='1'><TH colspan='2'align='center' bgcolor='orange' ><font size=1 face='Arial' color='white'>Datos Trayectoria</font></th></tr> <tr><td valign='top' height=40% align='left' bgcolor='lightgray'>";
...
echo "
<tr><td bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Fecha de Inicio</font></td>
<td ><font size=1 face='Arial' >".$fechini ."</font></td>


</tr>
<tr><td bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Fecha Final</font></td>
<td ><font size=1 face='Arial'>".$fechfin ."</font></td>
</tr>

<tr>
<td bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Cargo-Puesto</font></td>
<td ><font size=1 face='Arial'>".$carg ."</font></td>

</tr>


<tr>
<td bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Tipo de Trayectoria</font></td>
<td><font size=1 face='Arial'>".$type ."</font></td>
...
echo "<tr><td>";
echo "<table width=100% height=50%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><th bgcolor='orange' colspan=2><font size=1 face='Arial'  color='white'><center>Relaci&oacute;n</center></font></thead><tbody>";
echo "<tr>";


echo "<tr>";
echo "<th bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Nombre</font></td>";
echo "<td ><a href='/FichasBD/branches/SY/control.php?action=getficha&letra=".$row32[2] ."' target='fichas2' ><font size=1 face='Arial'>".$r32[1]." ".$r32[2]." ".$r32[3]." ".$r32[4]." ".$r32[5]." ".$r32[6]."</a></font></td>";
echo "</tr>";
echo "<tr>";
echo "<th bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Nombre</font></td>";
echo "<td ><a href='/FichasBD/branches/SY/control.php?action=getfinst&letra=".$row33[2] ."' target='fichas2' ><font size=1 face='Arial'> ".$r33[1]." ".$r33[2]." ".$r33[3]." ".$r33[4]." ".$r33[5]." ".$r33[6]."</a></font></td>";
echo "</tr>";
...
echo "<tr><td>";
echo "<table width=100% height=50%  align='left' style='text-align: left' ; ' border='1'  cellpadding='2' cellspacing='2'><th bgcolor='orange' colspan=2><font size=1 face='Arial'  color='white'><center>Relaci&oacute;n</center></font></th><tbody>";
echo "<tr>";


echo "<tr>";
echo "<th bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Nombre</font></td>";
echo "<td> <a href='/FichasBD/branches/SY/control.php?action=getficha&letra=".$row33[2] ."' target='fichas2' ><font size=1 face='Arial'> ".$r33[1]." ".$r33[2]." ".$r33[3]." ".$r33[4]." ".$r33[5]." ".$r33[6]."</a></font></td>";
echo "</tr>";

echo "<tr>";
echo "<th bgcolor='lightgray'><font size=1 face='Arial' color='blue'>Nombre</font></td>";
echo "<td ><a href='/FichasBD/branches/SY/control.php?action=getfinst&letra=".$row32[2] ."' target='fichas2' ><font size=1 face='Arial'>".$r32[1]." ".$r32[2]." ".$r32[3]." ".$r32[4]." ".$r32[5]." ".$r32[6]."</a></font></td>";
echo "</tr>";
}
