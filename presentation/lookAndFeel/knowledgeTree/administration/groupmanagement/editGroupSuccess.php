<?php
/**
 * $Id: editGroupSuccess.php,v 1.15 2004/11/03 08:12:29 nbm Exp $
 *
...
if (checkSession()) {
    ...
    $Center .= "<tr></tr>\n";
    $Center .= "<tr>\n";
    $Center .= "<td align = right><a href=\"$default->rootUrl/control.php?action=listGroups\"><img src =\"" . KTHtml::getBackButton() . "\" border = \"0\" /></a></td>\n";
    $Center .= "</tr>\n";
    $Center .= "</table>\n";
